...
### Model 2
```{r}
# create model2 by adding bathrooms, bedrooms, beds, accomodates to model 1
...
### Model 3
```{r}
# create model3 by adding bathrooms, bedrooms, beds, accommodates to model 2 
...
# create model4 by adding host_is_superhost to model 3
...
```
Since the p-value for the estimate of the superhost coefficient is not significant, it seems that superhost do not command a price premium from their guests in Copenhagen. 
