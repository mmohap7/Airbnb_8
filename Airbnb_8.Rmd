...
```
Since the p-value for the estimate of the superhost coefficient is not significant (with a p-value of 0.36 and a t-statistic of 0.9), it seems that superhosts do not command a price premium from their guests in Copenhagen. 

#### Model 4: 40% 
-> decrease, do not include superhost in next models 
